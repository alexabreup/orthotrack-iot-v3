...
- [ ] 13.5 Create viewer count indicator
  - Display eye icon when viewers > 1
  - Show tooltip with viewer names on hover
  - _Requirements: 8.4, 8.5_

- [ ] 13.6 Update dashboard with real-time statistics
  - Subscribe to dashboard channel
  - Update counters without reload
  - _Requirements: 6.1, 6.2, 6.3, 6.4, 6.5_

- [ ] 14. Implement reconnection UI feedback
- [ ] 14.1 Create reconnection indicator component
  - Display "Reconnecting..." banner at top
  - Show during reconnection attempts
  - _Requirements: 4.5_

- [ ] 14.2 Create reconnection success message
  - Display success message for 3 seconds
  - Remove indicator on success
  - _Requirements: 4.6_

- [ ] 14.3 Write property test for UI updates without reload
  - **Property 2: UI updates without page reload**
  - **Validates: Requirements 1.2**

- [ ] 15. Integrate WebSocket client with application
- [ ] 15.1 Create WebSocket service singleton
  - Initialize on app mount
  - Connect with JWT token
  - Make available globally
  - _Requirements: All_

- [ ] 15.2 Implement automatic subscription management
  - Subscribe/unsubscribe based on current route
  - Handle navigation between pages
  - _Requirements: 5.1, 5.2, 5.5_

- [ ] 15.3 Handle authentication errors
  - Redirect to login on 401
  - Show error message
  - _Requirements: 9.1, 9.2_

- [ ] 16. Add environment configuration
- [ ] 16.1 Configure WebSocket URL for development
  - Use ws://192.168.43.205:8080/ws for local development
  - _Requirements: All_

- [ ] 16.2 Configure WebSocket URL for production
  - Use wss://api.orthotrack.com/ws for production
  - _Requirements: All_

- [ ] 16.3 Add Redis configuration
